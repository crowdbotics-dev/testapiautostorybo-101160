...
## Project Structure
    ...
    ├── testapiautostorybo_101160  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_101160`
...
2. Clone this repo and `cd testapiautostorybo_101160`
